...
/*					$min = get_min();
					...
					echo "</tbody></table><hr>";
										...
										function jml_alternatif(){	
											include 'configdb.php';
											$alternatif = $mysqli->query("select * from alternatif where id_kain = '2'");
...
join supplier s ON (alt.id_sup = s.id_sup) where id_kain = '2';");
											if(!$alternatif){
												echo $mysqli->connect_errno." - ".$mysqli->connect_error;
												exit();
											}
...
join kecacatan d ON (alt.id_alternatif = d.id_alternatif) where id_kain = '2';");
											if(!$alternatif){
												echo $mysqli->connect_errno." - ".$mysqli->connect_error;
												exit();
											}
